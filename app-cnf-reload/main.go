...
func init() {
	...
	utilruntime.Must(automatev1.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "e12e1822.walk1ng.dev",
	})
	if err != nil {
	...
	if err = (&automatev1.Configuration{}).SetupWebhookWithManager(mgr); err != nil {
